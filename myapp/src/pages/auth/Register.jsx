  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:1000/api/users/register', {
        ...
        credentials: 'include', // because you're using express-session
      ...
      if (!response.ok) {
        ...
        localStorage.setItem('mentra_email', email);
          ...
          <form onSubmit={handleSubmit}>
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <p className="text-center text-gray-600 mb-6">
                ...
                <a href="/login" className="text-indigo-600 hover:text-indigo-700 font-medium hover:underline transition-colors">
                  Log in
                </a>
              </p>
